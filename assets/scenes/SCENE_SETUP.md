...
- เป็นฉากสำรวจแนวนอนกว้าง 2304 px พร้อมกล้องเลื่อนตามตัวละคร
- ใช้ตัวละคร monster trainer กึ่งจิบิจาก `assets/resources/characters`
- แบ่งพื้นที่เป็นโซนห้องนอน โต๊ะอาหาร ห้องปรุงยา/ครัว และเตาผิง
...
- ตัวละครเดินแนวนอนและมีระยะความลึกแบบ 2.5D พร้อม collider บริเวณเท้า
